...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "ASimplePost":
			resolverName, err := entityResolverNameForASimplePost(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "ASimplePost": %w`, err)
			}
			switch resolverName {
			...
			case "findASimplePostByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findASimplePostByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindASimplePostByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "ASimplePost": %w`, err)
				}
		...
		case "Identity":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Identity": %w`, err)
			}
			switch resolverName {
			...
			case "findIdentityByID":
				id0, err := ec.unmarshalNID2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findIdentityByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindIdentityByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Identity": %w`, err)
				}
		...
		case "UnavailableUser":
			resolverName, err := entityResolverNameForUnavailableUser(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "UnavailableUser": %w`, err)
			}
			switch resolverName {
			...
			case "findUnavailableUserByID":
				id0, err := ec.unmarshalNID2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findUnavailableUserByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindUnavailableUserByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "UnavailableUser": %w`, err)
				}
...
func entityResolverNameForASimplePost(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findASimplePostByID", nil
	}
	return "", fmt.Errorf("%w for ASimplePost", ErrTypeNotFound)
}

func entityResolverNameForIdentity(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
	...
	return "", fmt.Errorf("%w for Identity", ErrTypeNotFound)
}

func entityResolverNameForUnavailableUser(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findUnavailableUserByID", nil
	}
	return "", fmt.Errorf("%w for UnavailableUser", ErrTypeNotFound)
}
